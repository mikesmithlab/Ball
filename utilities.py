...
def viewDF(filename,numbrows = 100):
    ...
    print(ball.tail(n=20))
    #for num in nums:
    #    if num in ball['frame'].unique():
    #        pass
    #    else:
    #print(num)
...
if __name__ == '__main__':
    filename2 = filedialog.askopenfilename(initialdir='//media/ppzmis/data/BouncingBall_Data/HighSpeedBalls/P120_10mm/',title='Select Data File', filetypes = (('Datafile', '*.hdf5'),))    
    #print(filename2)
    #filename = filedialog.askopenfilename(initialdir='//media/ppzmis/data/BouncingBall_Data/HighSpeedBalls/P120_10mm/',title='Select Data File', filetypes = (('AVI', '*.avi'),))    
    #print(filename)
    #filename2 = '/media/ppzmis/data/BouncingBall_Data/HighSpeedBalls/P120_10mm/P120_10mm_0.5_data.hdf5'


    #filename = '/media/ppzmis/data/BouncingBall_Data/HighSpeedBalls/P120_10mm/P120_10mm_0.5_annotated.avi'
    #filename2 = '/media/ppzmis/data/BouncingBall_Data/HighSpeedBalls/P120_10mm/Previous/P120_10mm_0.5_data.hdf5'


    #filename = '/media/ppzmis/data/BouncingBall_Data/HighSpeedBalls/P120_10mm/Previous/P120_10mm_0.5_annotated.avi'
    #print(filename)
    #check(filename)
    ...
    #filename3 = filedialog.askopenfilename(initialdir='/media/ppzmis/data/BouncingBall_Data/HighSpeedBalls/',title='Select Data File', filetypes = (('Datafile', '*.hdf5'),))    
    #filename4 = filedialog.askopenfilename(initialdir='/media/ppzmis/data/BouncingBall_Data/HighSpeedBalls/',title='Select Data File', filetypes = (('Datafile', '*.hdf5'),))    
    
    
    
    #filename5 = filedialog.askopenfilename(initialdir='/media/ppzmis/data/BouncingBall_Data/HighSpeedBalls/',title='Select Data File', filetypes = (('AVI', '*.avi'),))    
    #filename6 = filedialog.askopenfilename(initialdir='/media/ppzmis/data/BouncingBall_Data/HighSpeedBalls/',title='Select Data File', filetypes = (('AVI', '*.avi'),))    
